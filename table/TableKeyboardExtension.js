...
// Provides helper ProjectName.control.table.TableKeyboardExtension.
sap.ui.define(['jquery.sap.global', './TableExtension', 'sap/ui/core/delegate/ItemNavigation', './TableUtils', './TableKeyboardDelegate' /*Switch to TableKeyboardDelegate2 for development of new keyboard behavior*/],
	...
	/**
	 * Extension for ProjectName.control.table.Table which handles keyboard related things.
	 *
	 * @class Extension for ProjectName.control.table.Table which handles keyboard related things.
	 *
	 ...
	 * @constructor
	 * @private
	 * @alias ProjectName.control.table.TableKeyboardExtension
	 */
	var TableKeyboardExtension = TableExtension.extend("ProjectName.control.table.TableKeyboardExtension", /* @lends ProjectName.control.table.TableKeyboardExtension */ {
