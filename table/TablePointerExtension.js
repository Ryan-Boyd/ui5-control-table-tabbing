...
// Provides helper ProjectName.control.table.TablePointerExtension.
sap.ui.define(['jquery.sap.global', './TableExtension', './TableUtils', 'sap/ui/Device'],
	...
	/**
	 * Extension for ProjectName.control.table.Table which handles mouse and touch related things.
	 *
	 * @class Extension for ProjectName.control.table.Table which handles mouse and touch related things.
	 *
	 ...
	 * @constructor
	 * @private
	 * @alias ProjectName.control.table.TablePointerExtension
	 */
	var TablePointerExtension = TableExtension.extend("ProjectName.control.table.TablePointerExtension", /* @lends ProjectName.control.table.TablePointerExtension */ {
