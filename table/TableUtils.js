...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler', './TableGrouping', './library'],
	...
	/**
	 * Static collection of utility functions related to the ProjectName.control.table.Table, ...
	 *
	 * @author SAP SE
	 * @version 1.42.8
	 * @namespace
	 * @name ProjectName.control.table.TableUtils
	 * @private
	 */
	var TableUtils = {
		 ...
		 * @return {Object}
		 * @type {Object}
		 * @property {ProjectName.control.table.CELLTYPES} type
		 ...
		 * @return {Object}
		 * @type {Object}
		 * @property {ProjectName.control.table.Row} row Row of the table
		 * @property {ProjectName.control.table.Column} column Column of the table
		 ...
		 *
		 * @param {ProjectName.control.table.Table} oControl Instance of the table
		 ...
		 * @param {ProjectName.control.table.Table} oTable Instance of the table
		 * @param {string} sSelectionMode the <code>ProjectName.control.table.SelectionMode</code>
		 * @returns {string} the sanitized <code>ProjectName.control.table.SelectionMode</code>
		 * @private
		 */
