...
// Provides control ProjectName.control.table.Column.
...
function(jQuery, Element, coreLibrary, Popup, RenderManager, Filter, FilterOperator, FilterType, Sorter, Type, StringType, library) {
	 ...
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.Column
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var Column = Element.extend("ProjectName.control.table.Column", /** @lends ProjectName.control.table.Column.prototype */ { metadata : {
		...
		properties : {
			 ...
			 * @see ProjectName.control.table.SortOrder (default value: "Ascending")
			 */
			sortOrder : {type : "ProjectName.control.table.SortOrder", group : "Appearance", defaultValue : SortOrder.Ascending},
		...
		aggregations : {
			...
			/**
			 * The menu used by the column. By default the {@link ProjectName.control.table.ColumnMenu} is used.
			 *
	 ...
	 *
	 * @type ProjectName.control.table.Column
	 * @public
