...
// Provides control ProjectName.control.table.AnalyticalTable.
sap.ui.define(['jquery.sap.global', './AnalyticalColumn', './Table', './TreeTable', './library', 'sap/ui/model/analytics/ODataModelAdapter', 'sap/ui/model/SelectionModel', 'sap/ui/model/Sorter', 'sap/ui/base/ManagedObject', 'sap/ui/core/Popup', 'sap/ui/unified/Menu', 'sap/ui/unified/MenuItem', './TableUtils'],
	 ...
	 *
	 * @extends ProjectName.control.table.Table
	 * @version 1.42.8
	 *
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.AnalyticalTable
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var AnalyticalTable = Table.extend("ProjectName.control.table.AnalyticalTable", /** @lends ProjectName.control.table.AnalyticalTable.prototype */ { metadata : {

		library : "ProjectName.control.table",
		properties : {
			 ...
			 * ProjectName.control.table.TreeAutoExpandMode
			 */
		...
		designTime : true
	}, renderer: "ProjectName.control.table.TableRenderer"});
	 ...
	 * @public
	 * @return {ProjectName.control.table.Table} a reference on the table for chaining
	 */
	 ...
	 * not supported and must not be used.
	 * @param {string} sBehavior the selection behavior, see ProjectName.control.table.SelectionBehavior
	 * @public
	 * @returns {ProjectName.control.table.Table} this for chaining
	 */
	 ...
	 * @returns {ProjectName.control.table.AnalyticalTable} this
	 * @private
 	 */
	...
	AnalyticalTable.prototype._attachBindingListener = function() {
		...
		// The event interface is the same as in sap.ui.model.SelectionModel, due to compatibility with the ProjectName.control.table.Table
	 ...
	 *
	 * @return {ProjectName.control.table.TreeTable} a reference on the TreeTable control, can be used for chaining
	 * @public
	...
	AnalyticalTable.prototype.refreshRows = function () {
		ProjectName.control.table.Table.prototype.refreshRows.apply(this, arguments);
	...
	AnalyticalTable.prototype.setEnableGrouping = function(bEnableGrouping) {
		jQuery.sap.log.warning("The property enableGrouping is not supported by control ProjectName.control.table.AnalyticalTable");
		return this;
	};
