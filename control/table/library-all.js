...
jQuery.sap.declare('ProjectName.control.table.library-all');
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalTable.designtime') ) {
/*!
...
jQuery.sap.declare('ProjectName.control.table.AnalyticalTable.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("ProjectName/control/table/AnalyticalTable.designtime",[],
	function() {
	"use strict";
...
}; // end of ProjectName/control/table/AnalyticalTable.designtime.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.ColumnMenuRenderer') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.ColumnMenuRenderer'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
...
sap.ui.define("ProjectName/control/table/ColumnMenuRenderer",['jquery.sap.global', 'sap/ui/core/Renderer', 'sap/ui/unified/MenuRenderer'],
...
}; // end of ProjectName/control/table/ColumnMenuRenderer.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.Table.designtime') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.Table.designtime'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("ProjectName/control/table/Table.designtime",[],
	function() {
	"use strict";
...
}; // end of ProjectName/control/table/Table.designtime.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TablePersoController') ) {
/*
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TablePersoController'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.ManagedObject'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TablePersoController",['jquery.sap.global', 'sap/ui/base/ManagedObject'],
...
}; // end of ProjectName/control/table/TablePersoController.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TreeAutoExpandMode') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TreeAutoExpandMode'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TreeAutoExpandMode",['jquery.sap.global'],
	function(jQuery) {
	"use strict";
...
}; // end of ProjectName/control/table/TreeAutoExpandMode.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.library') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 ...
 */
jQuery.sap.declare('ProjectName.control.table.library'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Core'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
jQuery.sap.require('sap.ui.unified.library'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/library",['jquery.sap.global', 'sap/ui/core/Core',
...
}; // end of ProjectName/control/table/library.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalColumnMenuRenderer') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.AnalyticalColumnMenuRenderer'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Renderer'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/AnalyticalColumnMenuRenderer",['jquery.sap.global', 'sap/ui/core/Renderer', './ColumnMenuRenderer'],
...
}; // end of ProjectName/control/table/AnalyticalColumnMenuRenderer.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.Column') ) {
/*!
* UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.Column'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
sap.ui.define("ProjectName/control/table/Column",['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/core/library', 'sap/ui/core/Popup', 'sap/ui/core/RenderManager', 'sap/ui/model/Filter', 'sap/ui/model/FilterOperator', 'sap/ui/model/FilterType', 'sap/ui/model/Sorter', 'sap/ui/model/Type', 'sap/ui/model/type/String', './library'],
...
}; // end of ProjectName/control/table/Column.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.Row') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
// Provides control ProjectName.control.table.Row.
jQuery.sap.declare('ProjectName.control.table.Row'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
jQuery.sap.require('sap.ui.model.Context'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/Row",['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/model/Context', './library'],
	 ...
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.Row
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var Row = Element.extend("ProjectName.control.table.Row", /** @lends ProjectName.control.table.Row.prototype */ { metadata : {
...
}; // end of ProjectName/control/table/Row.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableGrouping') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableGrouping'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
jQuery.sap.require('sap.ui.model.Sorter'); // unlisted dependency retained
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableGrouping",['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/model/Sorter', 'sap/ui/Device', './library'],
...
}; // end of ProjectName/control/table/TableGrouping.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableUtils') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
// Provides helper ProjectName.control.table.TableUtils.
jQuery.sap.declare('ProjectName.control.table.TableUtils'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.ResizeHandler'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableUtils",['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/ResizeHandler', './TableGrouping', './library'],
...
}; // end of ProjectName/control/table/TableUtils.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalColumn') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
// Provides control ProjectName.control.table.AnalyticalColumn.
jQuery.sap.declare('ProjectName.control.table.AnalyticalColumn'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
...
sap.ui.define("ProjectName/control/table/AnalyticalColumn",['jquery.sap.global', './Column', './library', 'sap/ui/core/Element',
	...
	function isInstanceOfAnalyticalTable(oControl) {
		return TableUtils.isInstanceOf(oControl, "ProjectName/control/table/AnalyticalTable");
	}
	 ...
	 * @extends ProjectName.control.table.Column
	 *
	 * @author SAP SE
	 * @version 1.42.8
	 *
	 ...
	 * @alias ProjectName.control.table.AnalyticalColumn
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var AnalyticalColumn = Column.extend("ProjectName.control.table.AnalyticalColumn", /** @lends ProjectName.control.table.AnalyticalColumn.prototype */ { metadata : {
	 ...
	 * Factory method. Creates the column menu.
	 *
	 * @return {ProjectName.control.table.AnalyticalColumnMenu} The created column menu.
	 */
	AnalyticalColumn.prototype._createMenu = function() {
		var AnalyticalColumnMenu = sap.ui.requireSync("ProjectName/control/table/AnalyticalColumnMenu");
...
}; // end of ProjectName/control/table/AnalyticalColumn.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.ColumnMenu') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.ColumnMenu'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.RenderManager'); // unlisted dependency retained
...
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/ColumnMenu",['jquery.sap.global', 'sap/ui/core/RenderManager', './library', 'sap/ui/unified/Menu', 'sap/ui/unified/MenuItem', 'sap/ui/Device', './TableUtils'],
...
}; // end of ProjectName/control/table/ColumnMenu.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.Object'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableExtension",['jquery.sap.global', 'sap/ui/base/Object', './TableUtils'],
...
}; // end of ProjectName/control/table/TableExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableKeyboardDelegate') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableKeyboardDelegate'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.Object'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableKeyboardDelegate",['jquery.sap.global', 'sap/ui/base/Object', './library', './Row', './TableExtension', './TableUtils'],
...
}; // end of ProjectName/control/table/TableKeyboardDelegate.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableKeyboardDelegate2') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableKeyboardDelegate2'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.base.Object'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableKeyboardDelegate2",['jquery.sap.global', 'sap/ui/base/Object', './library', './TableExtension', './TableUtils'],
...
}; // end of ProjectName/control/table/TableKeyboardDelegate2.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableKeyboardExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableKeyboardExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.delegate.ItemNavigation'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableKeyboardExtension",['jquery.sap.global', './TableExtension', 'sap/ui/core/delegate/ItemNavigation', './TableUtils', './TableKeyboardDelegate' /*Switch to TableKeyboardDelegate2 for development of new keyboard behavior*/],
...
}; // end of ProjectName/control/table/TableKeyboardExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TablePointerExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TablePointerExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TablePointerExtension",['jquery.sap.global', './TableExtension', './TableUtils', 'sap/ui/Device'],
...
}; // end of ProjectName/control/table/TablePointerExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableRenderer') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableRenderer'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
...
sap.ui.define("ProjectName/control/table/TableRenderer",['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/library', 'sap/ui/core/theming/Parameters', 'sap/ui/Device', './library', './TableUtils', 'sap/ui/core/Renderer', 'sap/ui/core/IconPool'],
...
}; // end of ProjectName/control/table/TableRenderer.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableScrollExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableScrollExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableScrollExtension",['jquery.sap.global', './TableExtension', './TableUtils'],
...
}; // end of ProjectName/control/table/TableScrollExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalColumnMenu') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.AnalyticalColumnMenu'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/AnalyticalColumnMenu",['jquery.sap.global', './ColumnMenu', './library'],
...
}; // end of ProjectName/control/table/AnalyticalColumnMenu.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableAccRenderExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableAccRenderExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableAccRenderExtension",['jquery.sap.global', './TableExtension'],
...
}; // end of ProjectName/control/table/TableAccRenderExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TableAccExtension') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TableAccExtension'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TableAccExtension",['jquery.sap.global', 'sap/ui/core/Control', './library', './TableExtension', './TableAccRenderExtension', './TableUtils'],
...
}; // end of ProjectName/control/table/TableAccExtension.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.Table') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.Table'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
jQuery.sap.require('sap.ui.Device'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
...
sap.ui.define("ProjectName/control/table/Table",['jquery.sap.global', 'sap/ui/Device',
...
}; // end of ProjectName/control/table/Table.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TreeTable') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TreeTable'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
jQuery.sap.require('sap.ui.core.Element'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/TreeTable",['jquery.sap.global', './Table', 'sap/ui/model/odata/ODataTreeBindingAdapter', 'sap/ui/model/ClientTreeBindingAdapter', 'sap/ui/model/TreeBindingCompatibilityAdapter', './library', 'sap/ui/core/Element', './TableUtils'],
...
}; // end of ProjectName/control/table/TreeTable.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.TreeTableRenderer') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.TreeTableRenderer'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("ProjectName/control/table/TreeTableRenderer",['ProjectName/control/table/TreeTable'], function(Table) {
	"use strict";
...
}; // end of ProjectName/control/table/TreeTableRenderer.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalTable') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.AnalyticalTable'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
jQuery.sap.require('sap.ui.unified.Menu'); // unlisted dependency retained
jQuery.sap.require('sap.ui.unified.MenuItem'); // unlisted dependency retained
sap.ui.define("ProjectName/control/table/AnalyticalTable",['jquery.sap.global', './AnalyticalColumn', './Table', './TreeTable', './library', 'sap/ui/model/analytics/ODataModelAdapter', 'sap/ui/model/SelectionModel', 'sap/ui/model/Sorter', 'sap/ui/base/ManagedObject', 'sap/ui/core/Popup', 'sap/ui/unified/Menu', 'sap/ui/unified/MenuItem', './TableUtils'],
...
}; // end of ProjectName/control/table/AnalyticalTable.js
if ( !jQuery.sap.isDeclared('ProjectName.control.table.AnalyticalTableRenderer') ) {
/*!
 * UI development toolkit for HTML5 (OpenUI5)
 * (c) Copyright 2009-2016 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
...
jQuery.sap.declare('ProjectName.control.table.AnalyticalTableRenderer'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
sap.ui.define("ProjectName/control/table/AnalyticalTableRenderer",['ProjectName/control/table/AnalyticalTable'], function(Table) {
	"use strict";
	// Renderer defined already in AnalyticalTable.js -> Keep this file for legacy purposes (e.g. AMD module dependencies)
	return Table.getMetadata().getRenderer();
}, /* bExport= */ true);
}; // end of ProjectName/control/table/AnalyticalTableRenderer.js