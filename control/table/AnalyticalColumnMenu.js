...
// Provides control ProjectName.control.table.AnalyticalColumnMenu.
sap.ui.define(['jquery.sap.global', './ColumnMenu', './library'],
	 ...
	 * @extends ProjectName.control.table.ColumnMenu
	 *
	 * @author SAP SE
	 * @version 1.42.8
	 *
	 ...
	 * @alias ProjectName.control.table.AnalyticalColumnMenu
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var AnalyticalColumnMenu = ColumnMenu.extend("ProjectName.control.table.AnalyticalColumnMenu", /** @lends ProjectName.control.table.AnalyticalColumnMenu.prototype */ { metadata : {
