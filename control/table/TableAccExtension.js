...
// Provides helper ProjectName.control.table.TableAccExtension.
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', './library', './TableExtension', './TableAccRenderExtension', './TableUtils'],
	...
	/**
	 * Extension for ProjectName.control.table.Table which handles ACC related things.
	 *
	 * @class Extension for ProjectName.control.table.Table which handles ACC related things.
	 *
	 ...
	 * @constructor
	 * @private
	 * @alias ProjectName.control.table.TableAccExtension
	 */
	var TableAccExtension = TableExtension.extend("ProjectName.control.table.TableAccExtension", /* @lends ProjectName.control.table.TableAccExtension */ {
