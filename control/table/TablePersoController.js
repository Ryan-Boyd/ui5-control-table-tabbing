...
sap.ui.define(['jquery.sap.global', 'sap/ui/base/ManagedObject'],
	 ...
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.TablePersoController
	 */
	var TablePersoController = ManagedObject.extend("ProjectName.control.table.TablePersoController", /** @lends ProjectName.control.table.TablePersoController.prototype */ {
				...
				for (var j = 0, lj = this._aColumnProperties.length; j < lj; j++) {
					...
					if (oColumnInfo[sProperty] !== undefined) {
						try {
							...
							jQuery.sap.log.error("ProjectName.control.table.TablePersoController: failed to apply the value \"" + oColumn[sProperty] + "\" for the property + \"" + sProperty + "\".");
						}
					}
				}
