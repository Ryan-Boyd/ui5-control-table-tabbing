...
// Provides control ProjectName.control.table.Table.
sap.ui.define(['jquery.sap.global', 'sap/ui/Device',
	 ...
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.Table
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var Table = Control.extend("ProjectName.control.table.Table", /** @lends ProjectName.control.table.Table.prototype */ { metadata : {

		library : "ProjectName.control.table.Table",
		properties : {
			 ...
			 */
			selectionMode : {type : "ProjectName.control.table.SelectionMode", group : "Behavior", defaultValue : SelectionMode.MultiToggle},
			 ...
			 */
			selectionBehavior : {type : "ProjectName.control.table.SelectionBehavior", group : "Behavior", defaultValue : SelectionBehavior.RowSelector},
			 ...
			 */
			navigationMode : {type : "ProjectName.control.table.NavigationMode", group : "Behavior", defaultValue : NavigationMode.Scrollbar},
			 ...
			 * @since 1.9.2
			 * @see ProjectName.control.table.VisibleRowCountMode
			 */
			visibleRowCountMode : {type : "ProjectName.control.table.VisibleRowCountMode", group : "Appearance", defaultValue : VisibleRowCountMode.Fixed},
		...
		aggregations : {
			 ...
			 */
			columns : {type : "ProjectName.control.table.Column", multiple : true, singularName : "column", bindable : "bindable"},

			/**
			 * Rows of the Table
			 */
			rows : {type : "ProjectName.control.table.Row", multiple : true, singularName : "row", bindable : "bindable"},
		...
		associations : {
			 ...
			 */
			groupBy : {type : "ProjectName.control.table.Column", multiple : false},
		...
		events : {
			...
			columnSelect : {allowPreventDefault : true,
				parameters : {
					 ...
					 */
					column : {type : "ProjectName.control.table.Column"}
				}
			},
			...
			sort : {allowPreventDefault : true,
				parameters : {
					 ...
					 * Sort Order
					 */
					sortOrder : {type : "ProjectName.control.table.SortOrder"},
	...
	Table.prototype.init = function() {
		...
		this._oResBundle = sap.ui.getCore().getLibraryResourceBundle("ProjectName.control.table");
	 ...
	 * @param {string} sSelectionMode the selection mode, see ProjectName.control.table.SelectionMode
	 * @public
	...
	Table.prototype.setFirstVisibleRow = function(iRowIndex, bOnScroll, bSupressEvent) {
		if (this.getNavigationMode() == ProjectName.control.table.NavigationMode.Paginator) {
			var iVisibleRowCount = this.getVisibleRowCount();
	 ...
	 * @return {ProjectName.control.table.Table} the table instance for chaining
	 * @private
	 */
	 ...
	 * @returns {ProjectName.control.table.Table} This-reference for chaining
	 * @public
	 * @override
	 */
	Table.prototype.setTooltip = function(vTooltip) {
		jQuery.sap.log.warning("The aggregation tooltip is not supported for ProjectName.control.table.Table");
	 ...
	 * @param {ProjectName.control.table.Row} oRow row to update
	...
	Table.prototype.onvscroll = function(oEvent) {
		 ...
		 * @param {ProjectName.control.table.Table} oTable Instance of the table.
		 */
	 ...
	 * @param {ProjectName.control.table.Column} oColumn
	 *         column to be sorted
	 * @param {ProjectName.control.table.SortOrder} oSortOrder
	 ...
	 *
	 * @return ProjectName.control.table.Table
	 * @public
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
	...
	*/
	 ...
	 *
	 * @param {ProjectName.control.table.Row[]} [aRows] Rows aggregation to be rendered.
