...
// Provides control ProjectName.control.table.TreeTable.
sap.ui.define(['jquery.sap.global', './Table', 'sap/ui/model/odata/ODataTreeBindingAdapter', 'sap/ui/model/ClientTreeBindingAdapter', 'sap/ui/model/TreeBindingCompatibilityAdapter', './library', 'sap/ui/core/Element', './TableUtils'],
	 ...
	 * @constructor
	 * @public
	 * @alias ProjectName.control.table.TreeTable
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var TreeTable = Table.extend("ProjectName.control.table.TreeTable", /** @lends ProjectName.control.table.TreeTable.prototype */ { metadata : {
	 ...
	 * @return {ProjectName.control.table.TreeTable} <code>this</code> to allow method chaining
	 * @public
	 */
	...
	TreeTable.prototype.getBinding = function(sName) {
		...
		if (oBinding && sName === "rows" && !oBinding.getLength) {
			...
			if (ODataTreeBinding && oBinding instanceof ODataTreeBinding) {
				...
				jQuery.sap.log.error("Binding not supported by ProjectName.control.table.TreeTable");
			}
		}
	...
	TreeTable.prototype.setEnableGrouping = function(bEnableGrouping) {
		jQuery.sap.log.warning("The property enableGrouping is not supported by control ProjectName.control.table.TreeTable");
		return this;
	};
