...
// Provides helper ProjectName.control.table.TableKeyboardDelegate2.
sap.ui.define(['jquery.sap.global', 'sap/ui/base/Object', './library', './TableExtension', './TableUtils'],
	...
	/**
	 * New Delegate for keyboard events of ProjectName.control.table.Table controls.
	 *
	 ...
	 * @constructor
	 * @private
	 * @alias ProjectName.control.table.TableKeyboardDelegate2
	 */
	var TableKeyboardDelegate = BaseObject.extend("ProjectName.control.table.TableKeyboardDelegate2", /* @lends ProjectName.control.table.TableKeyboardDelegate2 */ {
