...
// Provides helper ProjectName.control.table.TableAccRenderExtension.
sap.ui.define(['jquery.sap.global', './TableExtension'],
	...
	/**
	 * Extension for ProjectName.control.table.TableRenderer which handles ACC related things.
	 *
	 * @class Extension for ProjectName.control.table.TableRenderer which handles ACC related things.
	 *
	 ...
	 * @constructor
	 * @private
	 * @alias ProjectName.control.table.TableAccRenderExtension
	 */
	var AccRenderExtension = TableExtension.extend("ProjectName.control.table.TableAccRenderExtension", /* @lends ProjectName.control.table.TableAccRenderExtension */ {
