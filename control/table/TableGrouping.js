...
// Provides helper ProjectName.control.table.TableUtils.
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Element', 'sap/ui/model/Sorter', 'sap/ui/Device', './library'],
	...
	/**
	 * Static collection of utility functions related to grouping of ProjectName.control.table.Table, ...
	 *
	 * Note: Do not access the function of this helper directly but via <code>ProjectName.control.table.TableUtils.Grouping...</code>
	 *
	 * @author SAP SE
	 * @version 1.42.8
	 * @namespace
	 * @name ProjectName.control.table.TableGrouping
	 * @private
	 */
	var TableGrouping = {
		 ...
		 * @param {ProjectName.control.table.Table} oTable Instance of the table
		 * @param {ProjectName.control.table.Row} oRow Instance of the row
		 * @param {boolean} bChildren whether the row is a group (has children) or not
		...
		/*
		 * EXPERIMENTAL Grouping Feature of ProjectName.control.table.Table:
		 *
		...
		/**
		 * Initializes the experimental grouping for ProjectName.control.table.Table.
		 * @param {ProjectName.control.table.Table} oTable Instance of the table
		 * @private
		 */
		setupExperimentalGrouping : function(oTable) {
			...
			for (var i = iLength - 1; i >= 0; i--) {
				...
				if (sKey !== sNewKey) {
					var oGroupContext = aContexts[i + 1].getModel().getContext("/ProjectName.control.table.GroupInfo" + i);
			...
			var oGroupContext = aContexts[0].getModel().getContext("/ProjectName.control.table.GroupInfo");
			oGroupContext.__groupInfo =	{
		...
		/**
		 * Cleans up the experimental grouping for ProjectName.control.table.Table.
		 * @param {ProjectName.control.table.Table} oTable Instance of the table
		 * @private
		 */
